...
DROP TABLE IF EXISTS benzin;#Lösche die Tabelle example wenn sie existiert
CREATE TABLE IF NOT EXISTS benzin(
	id  INT(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
	datum  DATE NOT NULL,
	tachostand  VARCHAR(15) NOT NULL,
	liter  FLOAT(15),
	preis  FLOAT(15,2),
	
);
#Datenmanipulation
INSERT INTO benzin (datum, tachostand, liter, preis) VALUES
	("2009.10.20", "127580", 2, verbrauch_kubikmeter*0.9636*11.108, 6.10),
